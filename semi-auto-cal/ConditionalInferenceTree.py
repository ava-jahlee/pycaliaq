...
r_model = cf.ScriptingRModel(filename='data_1000', path='C:/Users/lablj/PycharmProjects/caliaq/_data/')
...
ctree_model.model_traversing(testmodel_dataframe = r_model_data, export = True, export_file_name = 'ctree_traverse_result')
